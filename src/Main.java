...
public class Main {
    public static void main(String[] args) {
        ...
        fileRepository1.save(new Student("123", "Student123", 123));
        fileRepository2.save(new Tema("123", "123", 123, 321));
        fileRepository3.save(new Nota(new Pair<>("123", "123"), 4d, 125, "feedback"));
